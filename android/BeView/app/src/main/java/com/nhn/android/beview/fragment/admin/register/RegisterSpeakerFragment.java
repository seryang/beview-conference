...
public class RegisterSpeakerFragment extends RegisterFragment implements View.OnClickListener, OnDateSelectedListener {
    ...
    public RegisterSpeakerFragment() {
    }

    public static RegisterSpeakerFragment newInstance(@Nullable Conference conference) {
        RegisterSpeakerFragment fragment = new RegisterSpeakerFragment();
