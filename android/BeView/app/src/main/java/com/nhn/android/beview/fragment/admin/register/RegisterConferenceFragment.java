...
public class RegisterConferenceFragment extends RegisterFragment implements View.OnClickListener, OnDateSelectedListener {
    ...
    public RegisterConferenceFragment() {
    }

    public static RegisterConferenceFragment newInstance(@Nullable Conference conference) {
        RegisterConferenceFragment fragment = new RegisterConferenceFragment();
