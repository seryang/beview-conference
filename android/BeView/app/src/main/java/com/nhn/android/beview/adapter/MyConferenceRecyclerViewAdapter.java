...
public class MyConferenceRecyclerViewAdapter extends RecyclerView.Adapter<MyConferenceRecyclerViewAdapter.ViewHolder> {
    ...
    public MyConferenceRecyclerViewAdapter(List<DummyItem> items, ConferenceFragment.OnConferenceFragmentListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onConferenceFragmentInteraction(holder.mItem);
                }
            }
        });
    }
