...
public class TrackSQL {
	...
	public static final String SELECT_TRACK_ALL_BY_CONFERENCE_ID = "SELECT track.* from track left join conference on track.conference_idx = conference.idx where track.conference_idx = ?";
	public static final String UPDATE_TRACK = "UPDATE track SET name = ?, location = ?, conference_idx = ? WHERE idx = ?";
