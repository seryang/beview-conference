...
public class ConferenceSQL {
	public static final String CONFERENCE_SELECT = "SELECT * FROM conference WHERE id = ?";
	...
	public static final String CONFERENCE_DELETE = "DELETE from conference WHERE id = ?";
}
