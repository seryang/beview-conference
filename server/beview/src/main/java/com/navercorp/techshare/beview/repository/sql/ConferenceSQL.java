...
public class ConferenceSQL {
	public static final String CONFERENCE_CHECK_BY_ID = "SELECT * FROM conference WHERE id = ?";
	public static final String CONFERENCE_CHECK_BY_ID_BEFORE_UPDATE = "SELECT * FROM conference WHERE id = ? and idx != ?";
