...
public class SessionSQL {
	...
	public static final String SESSION_SELECT_ALL_BY_TRACK_ID = "select session.* from session, track where session.track_idx = track.idx and track.idx = ? order by session.startTime asc";
